                    ...
                    <form action="{{route('Employees.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-control">
                                    <option value="0" {{ old('active') == 0 ? 'selected' : null }}>{{trans('back.active')}}</option>
                                    <option value="1" {{ old('inactive') == 1 ? 'selected' : null }}>{{trans('back.inactive')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <b class="text-danger">*</b>
                                <input type="date" class="form-control" placeholder="{{trans('employees.Join_date')}}" name="Join_date" value="{{old('Join_date')}}" required>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="email" class="form-control" placeholder="{{trans('employees.email')}} " name="email" value="{{old('email')}}" >
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <b class="text-danger">*</b>
                                <input type="text" class="form-control" placeholder="{{trans('employees.jop_ar')}} " name="jop_ar" value="{{old('jop_ar')}}" required>
                            </div>

                            <div class="form-group col-md-3">
                                <label for="jop_en">{{trans('employees.jop_en')}} </label>
                                <b class="text-danger">*</b>
                                <input type="text" class="form-control" placeholder="{{trans('employees.jop_en')}} " name="jop_en" value="{{old('jop_en')}}" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control" placeholder="{{trans('employees.birth_date')}} " name="birth_date" value="{{old('birth_date')}}" >
                            </div>

                            <div class="col-md-3">
                                <label for="gender">{{trans('employees.gender')}}</label>
                                <select name="gender" class="form-control">
                                    <option value="0" {{ old('gender') == 0 ? 'selected' : null }}>{{trans('employees.Male')}}</option>
                                    <option value="1" {{ old('gender') == 1 ? 'selected' : null }}>{{trans('employees.female')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="{{trans('employees.religion')}}" name="religion" value="{{old('religion')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="social_status">{{trans('employees.social_status')}}</label>
                                <input type="text" class="form-control" placeholder="{{trans('employees.social_status')}}" name="social_status" value="{{old('social_status')}}" >
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <b class="text-danger">*</b>
                                <input type="text" class="form-control" placeholder="{{trans('employees.id_number')}} " name="id_number" value="{{old('id_number')}}" required >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="start_date_id">{{trans('employees.date_of_issue')}}</label>
                                <input type="date" class="form-control" placeholder="{{trans('employees.date_of_issue')}} " name="start_date_id" value="{{old('start_date_id')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="end_date_id">{{trans('employees.Expiry_date')}}</label>
                                <input type="date" class="form-control" placeholder="{{trans('employees.Expiry_date')}}" name="end_date_id" value="{{old('end_date_id')}}" >
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="{{trans('employees.passport_number')}} " name="passport_number" value="{{old('passport_number')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="start_date_passport">{{trans('employees.date_of_issue')}}</label>
                                <input type="date" class="form-control" placeholder="{{trans('employees.date_of_issue')}} " name="start_date_passport" value="{{old('start_date_passport')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="end_date_passport">{{trans('employees.Expiry_date')}}</label>
                                <input type="date" class="form-control" placeholder="{{trans('employees.Expiry_date')}} " name="end_date_passport" value="{{old('end_date_passport')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="Place">{{trans('employees.place_of_issue')}}</label>
                                <input type="text" class="form-control" placeholder="{{trans('employees.place_of_issue')}}" name="Place" value="{{old('Place')}}" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="{{trans('employees.academic')}} " name="academic" value="{{old('academic')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="type_academic">{{trans('employees.type_academic')}} </label>
                                <input type="text" class="form-control" placeholder="{{trans('employees.type_academic')}} " name="type_academic" value="{{old('type_academic')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="date_academic">{{trans('employees.date_academic')}} </label>
                                <input type="date" class="form-control" placeholder="{{trans('employees.date_academic')}} " name="date_academic" value="{{old('date_academic')}}" >
                            </div>

                            <div class="form-group col-md-3">
                                <label for="place_academic">{{trans('employees.place_academic')}}</label>
                                <input type="text" class="form-control" placeholder="{{trans('employees.place_academic')}} " name="place_academic" value="{{old('place_academic')}}" >
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="{{trans('employees.address')}} " name="address" value="{{old('address')}}" >
                            </div>
