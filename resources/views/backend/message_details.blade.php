                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class=" text-center">
                            <h4>
                                <span class="text-primary font-weight-bold"> {{trans('messages.Employee_Name')}} :</span>
                                {{$message->employee->name_ar}}
                            </h4>
                            <h4>
                                <span class="text-primary font-weight-bold"> {{trans('messages.Message_title')}} :</span>
                                {{$message->title}}
                            </h4>

                            <h4>
                                <span class="text-primary font-weight-bold"> {{trans('messages.Date_Message')}} :</span>
                                {{$message->created_at}}
                            </h4>

                            <br>
                            <p>
                                <span class="text-primary font-weight-bold"> {{trans('messages.Message_details')}} :</span>
                                <br>
                                {!! $message->notes !!}
                            </p>
                        </div>
