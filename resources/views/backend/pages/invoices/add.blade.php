            ...
            <div class="card-box">
                <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" class="form-control form-control-sm total-after-discount text-center"
                                name="total_after_discount" step="any" value="0.000" readonly>
                        </div>

                        <div class="form-group col-md-2">
                            <label for="tax_percentage">{{ trans('back.tax') }} (%)</label>
                            <input type="number" class="form-control form-control-sm tax-percentage"
                                name="tax_percentage" step="0.01" value="{{ $setting->tax_percentage ?? 15 }}" min="0" max="100">
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle">
                                            ...
                                            <tbody id="installments-container">
                                                <tr class="installment-row" data-installment-index="0">
                                                    <td>
                                                        <input type="date" name="installments[0][due_date]" class="form-control form-control-sm first-installment-date" value="{{ date('Y-m-d') }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="installments[0][amount]" class="form-control form-control-sm installment-amount first-installment-amount text-center" step="any" value="0">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-danger btn-sm remove-installment" disabled>
                                                            <i class="fas fa-trash-alt"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="text-center">
                        <button type="submit"
                                    class="btn btn-success mt-2 text-center">{{ trans('back.create_invoice') }}</button>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function recalculateAll() {
                ...
                // Update first installment amount to match total
                $('.first-installment-amount').val(total.toFixed(3));

                // Update remaining amounts for installments
                updateInstallmentsRemaining();

                // Validate installments after recalculation
                validateInstallments();
            }
