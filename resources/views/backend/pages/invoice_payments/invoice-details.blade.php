            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start justify-content-between mb-4">
                        <div>
                            <img alt="dark logo" height="24" src="/images/logo-dark.png" />
                        </div>
                        <div class="text-end">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <img alt="qr-code-image" height="100" src="/images/png/qr-code.png" />
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                        ...
                        <table class="table text-center table-nowrap align-middle mb-0">
                            ...
                            <tbody id="products-list">
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center gap-2">
                                            <iconify-icon class="fs-22" icon="logos:react"></iconify-icon>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center gap-2">
                                            <iconify-icon class="fs-22" icon="logos:openai-icon"></iconify-icon>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center gap-2">
                                            <iconify-icon class="fs-22" icon="logos:apple-app-store"></iconify-icon>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center gap-2">
                                            <iconify-icon class="fs-22" icon="logos:digital-ocean-icon"></iconify-icon>
                                            <div>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="d-inline-block">
                            <img alt="signature" height="32" src="/images/png/signature.png" />
            ...
            <div class="d-print-none mb-5">
                <div class="d-flex justify-content-center gap-2">
                    <a class="btn btn-primary" href="javascript:window.print()"><i class="ti ti-printer me-1"></i>
                        Print</a>
                    <a class="btn btn-secondary" href="javascript: void(0);"><i class="ti ti-send me-1"></i>
                        Send</a>
