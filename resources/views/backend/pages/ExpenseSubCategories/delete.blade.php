<!-- Modal -->
<div class="modal fade" id="delete_ExpenseSubCategory{{$expenseSubCategory->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('ExpenseSubCategories.destroy', $expenseSubCategory->id)}}" method="post">
                    @csrf
                    @method('DELETE')
