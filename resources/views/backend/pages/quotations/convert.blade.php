...
<div class="modal fade" id="convert_quotation{{$quotation->id}}" tabindex="-1" aria-labelledby="convertModalLabel" aria-hidden="true">
            ...
            <div class="modal-body text-left">
                ...
                <form action="{{route('quotations.convertToInvoice', $quotation->id)}}" method="post">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>{{trans('back.note')}}:</strong> {{trans('back.invoice_will_create_with_one_installment')}}
                    </div>
