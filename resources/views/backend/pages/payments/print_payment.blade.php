...
<style>
    ...
    @media print {
        body, .container, .row, .card-box, .panel-body {
            padding: 0 !important;
            margin: 0 !important;
        }
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="float-left p-2">
                                    <p style="line-height: 30px">
                                        <strong>
                                            {{ trans('back.payment_date') }}: {{ $payment->created_at->format('Y-m-d') }}<br>
                                            {{ trans('back.receipt_number') }}: {{ $payment->payment_number }}<br>
                                            {{ trans('back.contract_number') }}: {{ $payment->StudentsContract->contract_number }}
                                        </strong>
                                    </p>
                                </div>
