...
@section('page_title')
    {{trans('back.edit_studentsContract')}} :
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <form action="{{route('studentsContracts.update', $studentsContract->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <label for="student_number">{{trans('back.student_number')}}</label>
                            <input type="text" class="form-control" placeholder="{{trans('back.student_number')}}" name="student_number" value="{{$studentsContract->student_number}}" >
                        </div>
...
<input type="hidden" class="original-tax" value="{{ $studentsContract->tax_value }}">
                                ...
                                <div class="form-group col-md-5">
                                    <button type="submit" class="btn btn-success w-100 btn-sm btn-block" style="margin-top:23px"> {{trans('back.update')}}</button>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="cart" class="table table-bordered table-sm text-center">
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="fees[{{ $tuitionFee->id }}][total]" value="{{ $tuitionFee->pivot->total }}">
