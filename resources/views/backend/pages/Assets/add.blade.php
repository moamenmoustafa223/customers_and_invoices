    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('back.add_new_asset')}}</h5>
                ...
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control Category" name="assets_category_id" id="Category" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control SubCategory" name="assets_sub_category_id" id="SubCategory">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="depreciation_rate" step="any" placeholder="{{trans('back.depreciation_rate')}}"  value="{{old('depreciation_rate')}}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="notes" id="notes" cols="30" rows="4">{{old('notes')}}</textarea>
                        </div>
