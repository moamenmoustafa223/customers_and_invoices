...
<head>
    <meta charset="utf-8" />
    <title>{{ trans('auth.login_student') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="{{ trans('auth.login_student') }}" name="description" />
...
<body class="authentication-bg20" style="background-image: url({{ asset('backend/bg-garage.jpg') }}) ">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="text-center">
                        <a href="/" class="logo text-center mb-2">
                            <img src="{{ asset(App\Models\Setting::first()->logo) }}" width="180"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                <h4 class="text-uppercase mt-0"> {{ trans('auth.login_student') }}</h4>
                            </div>

                            <form method="POST" action="{{ route('student_login_store') }}">
                                @csrf
