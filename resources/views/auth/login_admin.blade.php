...
<head>
    <meta charset="utf-8" />
    <title>{{ trans('auth.Administration_Login') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="{{ trans('auth.Administration_Login') }}" name="description" />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-3">
                                <h4 class="text-uppercase mt-0"> {{ trans('auth.Administration_Login') }}</h4>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3">
                                    <label for="emailaddress"> {{ trans('auth.email') }}</label>
                                    <input class="form-control" type="email" name="email" id="email" required
                                        autofocus placeholder="{{ trans('auth.email') }}" value="{{ old('email') }}">
                                </div>
